    ...
    return (
        <div name="home" style={{ backgroundImage: `url(${closeup})` }} className='text-white justify-center  bg-no-repeat bg-cover bg-center ' >
            <div className='bg-black/[.09]'>
                <div className='md:max-w-[900px]  mt-[-96px] w-full h-[32rem] md:h-screen mx-auto text-center flex  flex-col ' >
                    ...
                    <div className='flex justify-center items-center'>
                        <p className='md:text-4xl sm:text-4xl text-xl font-bold py-4 px-2 md:px-0'> Compassionate and personalized care</p>

                    </div>
                    <p className='md:text-2xl text-xl font-bold text-gray-100 px-3 md:px-0'> to residents in a supportive and homely environment.</p>
