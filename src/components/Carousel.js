...
const Carousel = () => {
    ...
    return (
        <div className="max-w-[1440px] mx-auto py-[3rem] px-4 justify-center pb-0">
                ...
                >
                    {data.resources.map((resource, index) => {
                        return (
                            ...
                            >
                                <button className="h-full w-full aspect-square block bg-center-center bg-contain bg-no-repeat  z-0"
